...
<html>
<head>
    <title>ChangePassword - JustSearch</title>
    <meta charset="utf-8">
        ...
        <div class="container mt-3">
            <div class="row mt-2">
                <div class="col-md-3 col-sm-6 mt-5" align="center">
                    <img src=<?php echo $Passport ?> width="200px" height="240px" class="rounded-circle mt-4"><br>
                    <!-- <form action="edited.php" method="POST"> -->
                    <a href="edit_userInfo.php"><button class="btn btn-block">Edit Info</button></a>
                       
                    <!-- </form> -->
                    <button class="btn btn-block mt-4" type="submit">Submit New Password</button></a><br>
                </div>
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="newSurname" disabled value="<?php echo $Surname ?>" placeholder="e.g Avatar" id="scrn">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control" id="oldP" name="oldPassword">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="newFirstname" disabled value="<?php echo $Firstname ?>"  placeholder="e.g Avatar">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control" name="newPassword" id="pwd1">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="newMiddlename" disabled value="<?php echo $Middlename ?>"  placeholder="e.g Avatar">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control" disabled name="newEmail" value="<?php echo $Email ?>"  placeholder="e.g example@justsearch.com">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="newMobile" disabled value="<?php echo $Mobile ?>"  placeholder="e.g 08011223344">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="newUser" disabled value="<?php echo $Username ?>"  placeholder="e.g saka">
                            </div>
                        </div>
                    </div>
                </div>
